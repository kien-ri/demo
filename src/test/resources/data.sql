...
VALUES
    ('Kotlin入門', 'コトリン ニュウモン', '山田太郎', 1, 100, FALSE, '2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    ('Java入門', 'ジャバー ニュウモン', '田中太郎', 2, 101, FALSE, '2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    ('PHP入門', 'ピーエイチピー ニュウモン', '田中太郎', 2, 101, TRUE, '2023-01-01 10:00:00', '2023-01-01 10:00:00'),
    ('Spring Boot 入門', 'スプリング ブート ニュウモン', '佐藤次郎', 3, 102, FALSE, '2023-02-01 10:00:00', '2023-02-01 10:00:00'),
    ('データベース基礎', 'データベース キソ', '山本花子', 4, 102, FALSE, '2023-02-02 10:00:00', '2023-02-02 10:00:00'),
    ('アルゴリズム入門', 'アルゴリズム ニュウモン', '田中一', 3, 103, FALSE, '2023-02-03 10:00:00', '2023-02-03 10:00:00'),
    ('ネットワーク入門', 'ネットワーク ニュウモン', '高橋健', 4, 103, FALSE, '2023-02-04 10:00:00', '2023-02-04 10:00:00'),
    ('AI入門', 'エーアイ ニュウモン', '山田健太', 5, 104, TRUE, '2023-02-07 10:00:00', '2023-02-07 10:00:00');